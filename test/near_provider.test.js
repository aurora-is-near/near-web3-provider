...
async function createEvmTransaction(web) {
    try {
        ...
        console.log(`Created new transaction: ${txResult.transactionHash}
on block: ${txResult.blockNumber}`);
        return txResult;
    } catch (e) {
        console.log(e);
        return e;
...
describe('\n---- PROVIDER ----', () => {
    ...
    describe.only('\n---- BLOCK & TRANSACTION QUERIES ----', () => {
        ...
        //     // NB: Near will time out if it cannot find the tx instead of failing
        //     // immediately.
