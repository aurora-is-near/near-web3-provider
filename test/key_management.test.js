...
describe('\n---- KEY MANAGEMENT ----', () => {
    test('signTypedData', withWeb3(async (web3) => {
        params = [utils.nearAccountToEvmAddress(ACCOUNT_ID), JSON.parse('{"types":{"EIP712Domain":[{"name":"name","type":"string"},{"name":"version","type":"string"},{"name":"chainId","type":"uint256"},{"name":"verifyingContract","type":"address"}],"AddUserRequest":[{"name":"handle","type":"bytes16"},{"name":"nonce","type":"bytes32"}]},"domain":{"name":"User Factory","version":"1","chainId":"98","verifyingContract":"0x805B9c39D919Dec9eCfF8c10C91479B4d68dA2F8"},"primaryType":"AddUserRequest","message":{"handle":"0x7573657248616e646c6531","nonce":"0xb28a876f70ba058235f107c1572570125abe7201231e2a80217010ea39eab209"}}')];
